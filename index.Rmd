...
FinalPassData <- CleanPassData %>% ggplot(aes(x = reorder(Nationality, AvgPassesAttPer90), 
                  ...
                  geom_col(position = "dodge") + 
                  theme_classic() + 
                  labs(title = "Average Passes Per 90 Minutes for Countries with More than 3 Outfield Players \n\ Who Have Played More than Half the EPL Season", 
                       subtitle = "", 
                       x = "Country", 
                       y = "Average Passes Per 90 Minutes", 
                       caption = "")
```
